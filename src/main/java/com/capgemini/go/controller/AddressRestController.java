...
public class AddressRestController {
	...
	@PostMapping("/add")
	public ResponseEntity<Boolean> createAddress(@RequestBody @Valid Map<String, Object> requestData) {
	...
	@PutMapping("/update")
	public ResponseEntity<Boolean> updateAddress(@RequestBody @Valid Map<String, Object> requestData) {
		AddressDto address = AddressUtil.convertToAddress(requestData);
	...
	public ResponseEntity<Boolean> deleteAddress(@RequestBody @Valid Map<String, Object> requestData) {
